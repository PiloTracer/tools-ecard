...
2. **Implement design in code**
   - Work directly in the project’s tech stack: see `DOCS_TECH_STACK.md`.
...
- **Remix 2.5.0** with file-based routing and server-side data loading
- **React 18.2.0** (functional components, hooks)
- **Tailwind CSS 3.4.13** (utility-first styling)
- **TypeScript 5.3.0** (strict mode, type safety)
...
- **Project uses Remix 2.5.0 + React 18**:
  - Use functional components with hooks.
  - Follow Remix patterns (loaders, actions, useLoaderData, useFetcher).
  - Use Tailwind CSS v3.4.13 utility classes directly in JSX.
...
- **Frontend:** Remix 2.5.0, React 18.2.0, Tailwind CSS 3.4.13, TypeScript 5.3.0
- **Frontend Apps:** `front-public/` (user-facing) and `front-admin/` (admin dashboard)
- **No UI component library** – build from scratch using Tailwind
- **Styling:** Utility-first with Tailwind CSS (PostCSS + Autoprefixer)

**Required Reading:**
- `DOCS_CONTEXT.md` – Overall project description and architecture
- `DOCS_TECH_STACK.md` – Complete tech stack for all services
- `.claude/project-map.md` – Navigation guide for codebase
...
**Important Notes:**
- Use idiomatic Remix patterns (loader, action, hooks)
