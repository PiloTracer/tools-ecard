# NEXT_UI Archive - completed UI iterations

> **Context budget: history is moved, never deleted.** `plans/NEXT_UI.md` keeps the live backlog; completed iterations live here.
> Moved out on 2026-09-15 (bloat trim). Verbatim; original order preserved.
