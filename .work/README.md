...
| `.work/PROTECTED_SURFACES.json` | Project high-blast paths (blast-radius / protected-surfaces gate) |
| `.work/touch-scope` | Session/task allowed-path declaration |
