...
> Moved out of `HANDOFF.md` on 2026-09-15 (bloat trim). Moved text is verbatim; original order preserved.
> Authoritative copy of this history also remains in git history prior to this change.
---

<!-- moved from HANDOFF.md L11-L59 -->
...
<!-- moved from HANDOFF.md L122-L145 -->
...
<!-- moved from HANDOFF.md L189-L547 -->
## Cross-framework action (@x-director)
...
## Resolved owner actions

Moved out of `HANDOFF.md` § Open owner actions on 2026-09-15 (resolved rows stay out of an *open* table). Verbatim:
...
> Full original still in git history before this change.
